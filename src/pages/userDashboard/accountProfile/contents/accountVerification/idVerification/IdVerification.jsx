...
import { IdVerificationSuccessCard } from './IdVerificationSuccessCard';
import { IdVerificationModal } from './IdVerificationModal';
import { idVerificationData } from './data';
import { AccountVerificationModal } from '../AccountVerificationModal';

export const IdVerification = ({ type, icon, title, value, description }) => {
      ...
      {error && (
        <article className="border border-[#BE0F02] p-2 bg-[#FEF0F0] rounded-[6px] mt-2">
          <p className="text-[#BE0F02] font-inter text-sm">
            ...
            {idVerificationData?.data?.errorMessage}
          </p>
        </article>
      )}
