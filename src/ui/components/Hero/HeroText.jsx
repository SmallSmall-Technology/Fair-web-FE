...
export const HeroText = () => {
  ...
  return (
    <section className="flex flex-col gap-4 justify-center items-center my-8">
      <h1 className="font-bold text-5xl mb-2" ref={textRef}>
        Shop today, Pay later
      </h1>
      <p className="font-light w-[40%] text-center" ref={payRef}>
      ...
      <div className="flex gap-2">
        <Button className="group relative inline-flex items-center overflow-hidden rounded-full bg-[#FFDE11]  border-2 border-[#FFDE11] px-12 py-3 text-lg font-medium text-black hover:bg-gray-50 hover:text-black">
        ...
        <Button className="group relative inline-flex items-center overflow-hidden rounded-full border-2 border-white px-12 py-3 text-lg font-medium text-black hover:bg-gray-50 hover:text-black underline">
