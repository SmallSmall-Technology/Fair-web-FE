...
export const ShoppingOverviewSideBar = () => {
  return (
    <ul className="flex items-center lg:items-start space-x-3 mb-4 border-b-2 w-full pb-4 lg:border-none lg:pb-0 overflow-x-auto lg:flex-col lg:space-y-4 lg:space-x-0">
