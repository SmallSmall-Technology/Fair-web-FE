...
const routes = [
  <Route key="layout" path="" element={<Layout />}>
    ...
    <Route
      ...
      element={
        <Suspense
          fallback={<ProductDetailsSkeleton showAside showRecommendations />}
        >
          <SingleProductPage />
        </Suspense>
      }
  ...
  <Route key="protected-checkout" element={<ProtectedRoute />}>
    <Route
  ...
  <Route key="auth-signup" path="/sign-up" element={<SignUp />} />,
  ...
  />,
  <Route key="auth-reset" path="/reset-password" element={<ResetPassword />} />,

  <Route key="not-found" path="*" element={<PageNotFound />} />,

  <Route key="protected-dashboard" element={<ProtectedRoute />}>
