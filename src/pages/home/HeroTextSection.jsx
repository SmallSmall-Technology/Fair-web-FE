    ...
    <div className="font-medium text-[23px] mt-5 mb-8 g grid gap-3 lg:flex lg:space-x-3 items-center lg:mx-4">
      ...
      {!isAuthenticated && (
        <div className="flex space-x-3">
          <Button
            className="bg-[var(--yellow-primary)] rounded-[20px] border px-3 py-1 text-black font-medium 
          ...
          <Button
            className="border border-[#222224] rounded-[20px] px-3 py-1 text-black font-medium 
