...
import CartItemFullPayment from '../../productCategories/productDetails/productPlan/FullPaymentPlan/CartItemFullPayment';
...
export const PaymentPlan = ({ item, togglePlan }) => {
  ...
  const currentPlan = item.paymentPlan || item.selectedPaymentPlan;
  ...
  return (
    <section className="lg:mx-4 overflow-x-auto">
      ...
      >
        {currentPlan === 'full' && <CartItemFullPayment product={item} />}
